## **Vehicle Management - Minimal API**

This project is a **Minimal API built with ASP.NET Core**, designed to manage vehicle data in a secure and efficient way. It integrates with **SQL Server** for persistent data storage and uses **JWT (JSON Web Token)** for user authentication.
